...
public class BossTurret : MonoBehaviour
{
    ...
    [Tooltip("Offset de rotación para corregir la orientación base del sprite. " +
             "Ajustá este valor si el sprite no apunta en la dirección correcta. " +
             "Ej: 90 si el sprite mira hacia arriba por defecto.")]
    ...
    [Tooltip("Solo si esta torreta corre sus patrones de forma independiente (no controlada por BossController).")]
    ...
    private IEnumerator RunPatternRoutine(AttackPatternSO pattern, float duration)
    {
        ...
        _activeExecuteCoroutine = StartCoroutine(pattern.ExecutePattern(this));
